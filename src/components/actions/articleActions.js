...
export const getArticles = () => (dispatch) => {
  fetch("https://deploy-my-back.vercel.app/api/article/articles")
  ...
  return async function (dispatch) {
    try {
      const res = await fetch(
        "https://deploy-my-back.vercel.app/api/article/create",
        {
          method: "post",
          body: JSON.stringify({
            title: title,
...
export function deleteArticle(userId, _id, navigate) {
  return async function (dispatch) {
    try {
      const res = await fetch(
        `https://deploy-my-back.vercel.app/api/article/articles/${_id}?userId=${userId}`,
        {
          method: "DELETE",
          //  body: JSON.stringify({ title, name, userId,id:_id ,text}),
          headers: {
